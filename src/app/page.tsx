    ...
    <main className="site-shell">
      ...
      <section className="dashboard">
        <a className="panel panel-wide cream-panel" href="/delivery">
          ...
          <div><p className="eyebrow">MY ORDER</p><h2>배송 & KEEP 조회</h2><p>내 물건 어디까지 왔지?</p></div>
          <span className="arrow">→</span>
        </a>
        <div className="two-col">
          <a className="panel yellow-panel" href="/random">
            <div className="window"><div className="tiny-breads"><span /><span /><span /></div></div>
            <p className="eyebrow">OPEN NOW</p><h2>랜깡 LIST</h2><p>오늘 뭐 깔까?</p><span className="corner-bolt">ϟ</span>
          </a>
          <a className="panel blue-panel" href="/catalog">
            <div className="card-stack" aria-hidden="true"><span /><span /><span /></div>
            <p className="eyebrow">CARD BOOK</p><h2>도감</h2><p>시리즈별 카드 한눈에</p><span className="arrow light">→</span>
          </a>
        </div>
        <div className="mini-factory"><Breads count={7} /></div>
      </section>
      <nav className="bottom-nav">
        <a className="active" href="/">HOME</a><a href="/random">랜깡</a><a href="/catalog">도감</a><a href="/delivery">배송</a>
      </nav>
    </main>
  );
}
